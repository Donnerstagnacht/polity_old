...
--ALTER TABLE notifications_of_groups DISABLE ROW LEVEL SECURITY;  --REVIEW
--ALTER TABLE notifications_of_user DISABLE ROW LEVEL SECURITY;  --REVIEW
...
ALTER TABLE public.events_participants DISABLE ROW LEVEL SECURITY;
ALTER TABLE public.events_counters DISABLE ROW LEVEL SECURITY;